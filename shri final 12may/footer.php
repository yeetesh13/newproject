        ...
        <div class="col-md-7">
          ...
          <div class="col-sm-1 hidden-md-down">
            ...
            <div class="col-sm-11 text-white">
                <div><h4>  Contact</h4>
                    <p>   <span class="header-font"></span><span class="header-font"></span>SHRIUPI.IN</p>
                </div>
            </div>
            </div>
        </div>
...
<p class="text-center"> Copyright © Shrivalli H S|| Yeetesh Pranay... All rights reserved. </p>
